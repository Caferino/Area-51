...
var usable = {
	"healing": preload("res://Inventory System/scripts/resources/usable_items/item_healing.gd"),
	"upgrade": preload("res://Inventory System/scripts/resources/usable_items/item_upgrade.gd")
}
