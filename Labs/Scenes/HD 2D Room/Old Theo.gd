...
func handle_animation():
	...
	if direction == Vector2.ZERO:
		...
		head_animatorTree.get("parameters/Movement/playback").travel("Walk")
		head_animatorTree.set("parameters/Movement/Idle/blend_position", direction)
		head_animatorTree.set("parameters/Movement/Walk/blend_position", direction)
		
		body_animatorTree.get("parameters/Movement/playback").travel("Walk")
		# body_animatorTree.set("parameters/TimeScale/scale", 0.5)
		body_animatorTree.set("parameters/Movement/Idle/blend_position", direction)
		body_animatorTree.set("parameters/Movement/Walk/blend_position", direction)
