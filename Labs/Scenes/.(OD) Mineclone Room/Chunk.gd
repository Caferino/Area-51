...
var material = preload("res://Labs/Scenes/(OD) Mineclone Room/new_standard_material_3d.tres")
...
func update():
	...
	# TODO: For anyone who has weird lighting on the edges of the mesh in Godot 4, try adding st.set_smooth_group(-1) just after st.begin(Mesh.PRIMITIVE_TRIANGLES).
